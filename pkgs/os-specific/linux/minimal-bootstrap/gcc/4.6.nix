...
let
  pname = "gcc";
	...
	altSources = {
  	...
  	riscvFork = {
    	src = fetchurl {
        url = "https://codeberg.org/ekaitz-zarraga/gcc/archive/d7eeaf6c671560d76bce7218456e4ec49b05c26e.tar.gz";
        hash = "sha256-fi+s4ZhaCSiBsVhrA9eb3lz1sgcouHR/wxf04Fu+rAQ=";
      };
      version = "4.6.4.1-unstable-2024-05-23";
      dir = "gcc-d7eeaf6c671560d76bce7218456e4ec49b05c26e";
  	};
  	aarch64Backport = {
    	src = fetchurl {
	...
	altSource = {
  	...
  	riscv64-linux = altSources.riscvFork;
