...
# Do not edit!
{
  aarch64.linux.mescc = {
    libc_mini_SOURCES = [
      ...
      "lib/mes/globals.c"
      "lib/stdlib/exit.c"
      "lib/linux/aarch64-mes-mescc/_exit.c"
      "lib/linux/aarch64-mes-mescc/_write.c"
      "lib/stdlib/puts.c"
      "lib/string/strlen.c"
      "lib/mes/write.c"
    ];
    libmescc_SOURCES = [
      "lib/mes/globals.c"
      "lib/linux/aarch64-mes-mescc/syscall-internal.c"
    ];
    libtcc1_SOURCES = [
      "lib/libtcc1.c"
    ];
    libc_SOURCES = [
      ...
      "lib/linux/wait4.c"
      "lib/linux/waitpid.c"
      "lib/linux/aarch64-mes-mescc/syscall.c"
      "lib/linux/getpid.c"
      "lib/linux/kill.c"
    ];
    libc_tcc_SOURCES = [
      ...
      "lib/aarch64-mes-mescc/setjmp.c"
    ];
    libc_gnu_SOURCES = [
      "lib/mes/__init_io.c"
      "lib/mes/eputs.c"
